...
Extracting information from stochastic fields is a ubiquitous task in science. However, from cosmology to biology, it tends to be done either through a [power spectrum analysis](https://en.wikipedia.org/wiki/Spectral_density), which is often too limited, or the use of [convolutional neural networks](https://en.wikipedia.org/wiki/Convolutional_neural_network), which require large training sets and lack interpretability. A new powerful tool called the [scattering transform](https://arxiv.org/abs/1101.2286) stands nicely between the two extremes. I studied in depth how to [**intuitively understand**](https://arxiv.org/abs/2112.01288) this new statistic which is unfamiliar to most physicists, and I showed that in [cosmology](https://en.wikipedia.org/wiki/Observable_universe#Large-scale_structure) it outperforms classic statistics and is [**on a par with neural networks**](https://ui.adsabs.harvard.edu/abs/2020MNRAS.499.5902C/abstract). My paper won an [award](http://iaa.mi.oa-brera.inaf.it/IAA/awards.html) of astrostatistics and was reported by this [astrobites blog](https://astrobites.org/2020/07/30/scattering-stat/).
