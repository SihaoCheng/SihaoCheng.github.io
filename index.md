...
NEWS! While searching for [Planet X/Planet 9](https://en.wikipedia.org/wiki/Planet_Nine), I found [**an extreme "cousin" of Pluto**](https://www.ias.edu/news/extreme-cousin-pluto-possible-dwarf-planet-discovered-solar-systems-edge), temporarily named as [2017 OF201](https://en.wikipedia.org/wiki/2017_OF201). It is likely **large** enough to qualify as a [**dwarf planet**](https://en.wikipedia.org/wiki/Dwarf_planet), and its orbit is **extremely wide** that it should come from the [inner Oort cloud](https://en.wikipedia.org/wiki/Hills_cloud), a remote region in the solar system we still know little about. It also has interesting implications to the Planet 9 hypothesis.  Here is [my paper](https://ui.adsabs.harvard.edu/abs/2025arXiv250515806C/abstract).  Media articles explaining my discovery can be found here: [IAS](https://www.ias.edu/news/extreme-cousin-pluto-possible-dwarf-planet-discovered-solar-systems-edge), [Princeton University](https://web.astro.princeton.edu/news/princeton-astronomers-discover-extraordinary-distant-object-solar-systems-edge), [1](https://www.newscientist.com/article/2481477-new-dwarf-planet-spotted-at-the-edge-of-the-solar-system/#:~:text=A%20potential%20dwarf%20planet%20has,Planet%209%20or%20Planet%20X), [2](https://www.livescience.com/space/planets/scientists-have-discovered-a-new-dwarf-planet-in-our-solar-system-far-beyond-the-orbit-of-neptune), [3](https://phys.org/news/2025-05-extreme-cousin-pluto-dwarf-planet.html), [4](https://www.sciencealert.com/scientists-discover-new-dwarf-planet-in-solar-system-far-beyond-pluto), [4](https://www.iflscience.com/newest-member-of-the-solar-system-just-announced-and-its-in-an-extreme-orbit-79322), [5](https://earthsky.org/space/new-minor-planet-found-in-the-distant-solar-system-2017-of201/), [6](https://economictimes.indiatimes.com/news/international/global-trends/2017-of201-all-about-the-new-planet-found-beyond-pluto/articleshow/121382387.cms?from=mdr), etc.
...
Extracting information from stochastic fields is a ubiquitous task in science. However, from cosmology to biology, it tends to be done either through a [power spectrum analysis](https://en.wikipedia.org/wiki/Spectral_density), which is often too limited, or the use of [convolutional neural networks](https://en.wikipedia.org/wiki/Convolutional_neural_network), which requires large training sets and lack interpretability. I showed that a new powerful tool called the [scattering transform](https://arxiv.org/abs/1101.2286) stands nicely between the two extremes. I studied in depth how to [**intuitively understand**](https://arxiv.org/abs/2112.01288) this new statistic which is unfamiliar to most physicists, and used [cosmology](https://en.wikipedia.org/wiki/Observable_universe#Large-scale_structure) as an example where its performance is [**on a par with neural networks**](https://ui.adsabs.harvard.edu/abs/2020MNRAS.499.5902C/abstract) while being well-structured statistics. My paper won an [award](http://iaa.mi.oa-brera.inaf.it/IAA/awards.html) of astrostatistics and was reported by this [astrobites blog](https://astrobites.org/2020/07/30/scattering-stat/).

Recently, we successfully applied this new tool to [real weak lensing data](https://ui.adsabs.harvard.edu/abs/2024arXiv240416085C/abstract) with expected improvement, and we argued that photo-z calibration rather than spatial statistic becomes the main limitation.

To advocate the use of the scattering transform, I wrote a publicly available module [`ST.py`](https://github.com/SihaoCheng/scattering_transform) based on pytorch, which can implement 1D and 2D scattering transform in a fast and transparent way.
<br>
...
I also work on [white dwarfs](https://en.wikipedia.org/wiki/White_dwarf), the destiny of most stars in the universe. Using data from the [_Gaia_](https://www.cosmos.esa.int/web/gaia/home) space mission, I discovered a new population of white dwarfs that **cool extremely slowly** and some others that are **merger products**. My work has led to two papers (click the figures below), one of which was highlighted by [astrobites](https://astrobites.org/2019/11/12/the-slowly-cooling-white-dwarfs-who-say-ne/) and [AAS Nova](https://aasnova.org/2019/11/19/the-slowly-cooling-white-dwarfs-who-say-ne/) and considered a major discovery in Gaia data. More recently, we explained the astounding physics behind it in a [Nature](https://www.nature.com/articles/s41586-024-07102-y.epdf?sharing_token=6Fo5MeeV6DtHr_ZPzpQPF9RgN0jAjWel9jnR3ZoTv0MUbqXY_GqhdRlxZyDGYY3HSZnFjlZb7aRNzmzancdDVzw-jIFvz6nvI2ifzDYliW4czTow3X_VpRLXsPep6FI_Ha2iFL7JG6e7Abx9Mag-sS0_HCdjjKprVvb7Dzl3_VY%3D) paper, which is covered by [Physics Today](https://pubs.aip.org/physicstoday/online/43238), [elementy](https://elementy.ru/novosti_nauki/434205/Kristallizatsiya_yadra_tormozit_ostyvanie_belykh_karlikov#forum) and many other media. I am very proud of this discovery!
...
<a href="https://www.ebay.com/itm/144142982226"><img src="https://sihaocheng.github.io/prism.jpg" width="215" /></a>
...
2012-2016, B.S.
<br>
Advisor: Prof. [Eric Peng (彭逸西)](http://kiaa.pku.edu.cn/info/1012/2660.htm)
<br>
