...
In a recent paper (which won an [award](http://iaa.mi.oa-brera.inaf.it/IAA/awards.html) from the International Astrostatistics Association), I provided intuitive understandings of this method and showed that it outperforms classic statistics and extracts similar information as CNNs from [weak lensing](https://en.wikipedia.org/wiki/Weak_gravitational_lensing) [mass maps](https://en.wikipedia.org/wiki/Observable_universe#Large-scale_structure). Read [this astrobites blog](https://astrobites.org/2020/07/30/scattering-stat/) or click the figures below for details.
<br>
